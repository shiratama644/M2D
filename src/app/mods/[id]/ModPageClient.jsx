...
export default function ModPageClient({ project }) {
  ...
  return (
    <div style={{ minHeight: '100vh' }}>
      ...
      <header className="header">
        <Link href="/" className="header-back-link" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontWeight: 'bold', color: 'var(--accent-color)' }}>
          ← M2D
        </Link>
