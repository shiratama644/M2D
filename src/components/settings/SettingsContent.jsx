...
/**
 * The shared body of the settings form, used by both the mobile SettingsModal
 * and the desktop InlineSettings panel inside RightPanel.
 *
 * Props:
 *   gameVersions – array of released Minecraft version objects from useGameVersions()
 */
export default function SettingsContent({ gameVersions }) {
  const {
    theme, toggleTheme,
