...
import { FALLBACK_ICON, LEVEL_COLORS } from '../../lib/helpers';
...
// ---------------------------------------------------------------------------
// Upper Panel (Description / History / Settings)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Lower Panel (Selected / Favorites / Console)
// ---------------------------------------------------------------------------
...
function LowerPanel() {
  ...
  // Load metadata for favorites that aren't cached yet
              ...
              return (
                <div key={id} className="rp-mod-item">
                  ...
                  <button
                    ...
                    className="btn-small rp-fav-mod-star"
...
// ---------------------------------------------------------------------------
// RightPanel with vertical resizer
// ---------------------------------------------------------------------------
