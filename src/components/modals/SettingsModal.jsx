        ...
        <div className="modal-body">
          ...
          <div className="settings-category">
            ...
            <div className="settings-row">
              ...
              <CustomSelect className="settings-select" options={themeOptions} value={theme} onChange={toggleTheme} />
            </div>
            <div className="settings-row">
              <div>
              ...
              <CustomSelect className="settings-select" options={languageOptions} value={language} onChange={toggleLanguage} />
            </div>
            <div className="settings-row">
              <div>
