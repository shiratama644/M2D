...
| 🟡 中 | 13 | **1** | 12 | CORS 未設定、セキュリティヘッダー欠如、パフォーマンス問題、キャッシュ設定、レンダー中状態更新、AbortSignal 未使用、メモリリーク |
| 🟢 低 | 15 | **2** | 13 | アクセシビリティ、デッドコード、テスト不足、クリップボードエラーハンドリング、翻訳フィードバック不足、タイマーリーク、重複チェック欠如、変数シャドーイング |
| **合計** | **41** | **15** | **26** | |
